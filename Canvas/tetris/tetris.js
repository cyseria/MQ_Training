...
var NO_BLOCK = 0;  // 没方块是0

var tetris_canvas; 
var tetris_ctx;

var curScore = 0; // 记录当前积分
var curSpeed = 1; // 记录当前速度
var maxScore = 0; // 记录曾经的最高积分
var curScoreEle , curSpeedEle , maxScoreEle;
var curTimer;

var isPlaying = true; // 记录当前是否游戏中的旗标

var currentFall; // 记录正在下掉的四个方块
